            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <?= lang('Kiểu hiển thị', 'products_page'); ?>
                        ...
                        <div class="form-group">
                            <?= lang('Trang giới thiệu', 'about_link'); ?>
                            <?php
                        ...
                        <div class="form-group">
                            <?= lang('Trang điều khoản', 'terms_link'); ?>
                        ...
                        <div class="form-group">
                            <?= lang('Trang chính sách', 'privacy_link'); ?>
                        ...
                        <div class="form-group">
                            <?= lang('Trang liên hệ', 'contact_link'); ?>
                        ...
                        <div class="form-group">
                            <?= lang('Hiển thị chính sách', 'private'); ?>
